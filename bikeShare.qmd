...
# Now that we have a filtered data file, time to remove the old folder/files.
...
dir.create("duck_fltr")

# Helpful to create a persistent database file. 
dbconn <- DBI::dbConnect(duckdb::duckdb(),
                         dbdir = "duck_fltr/fltrd_data.duckdb",
                         read_only = FALSE)
