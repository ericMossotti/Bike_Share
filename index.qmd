...
#| code-summary: Write frequency comparison tables to the database
...
:::{.p-3}
```{r}
#| label: freqCompare_months Table
...
#### MPH Frequency by Membership {#group_mph_freq}

:::: {.d-flex .align-content-stretch}
:::{.p-3}
```{r}
#| label: mphCompare_table
...
sampled_stations_sf <- sampled_stations |>
    sf::st_as_sf(coords = c(3:2),
                 crs = 4326)
    
mapview::mapview(
    x = sampled_stations_sf,
    zcol = "station_names",
