...
::: {.btn .btn-outline-warning type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvas100" aria-controls="offcanvas"}
...
Code processing steps are accessible via links like the one below. Drop-down code summaries provide context on data processing rationale and methodology at various analysis stages, enhancing reader understanding.
:::

::: {.d-flex .justify-content-center .mb-3 .mt-3}
::: {.btn .btn-outline-info type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvas1" aria-controls="offcanvas"}
...
::: {.btn .btn-outline-info type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvas2" aria-controls="offcanvas"}
...
transFilter(conxn = dbconn, oldPath = "db/data_unduped.db", newPath = tblPath_fltrd)
}
```
:::
...
-   @tbl-memberTotals and @fig-totalMemberFreqency gives an idea of the membership distribution.
:::

::: {.btn .btn-outline-light .mb-4 type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvas33243" aria-controls="offcanvas"}
Update Database =\> Preview Table
:::
:::
...
location_list <- dplyr::tbl(dbconn, "db/membership.db") |>
dplyr::select(member_casual) |>
dplyr::group_by(member_casual) |>
dplyr::summarize(n = dplyr::n()) |>
colnames() |>
...
::: {.btn .btn-outline-light .mb-4 type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvas48" aria-controls="offcanvas" btn-border-width="0px"}
Update Database =\> Preview Table
:::
:::
...
location_list <- dplyr::tbl(dbconn, "db/bType.db") |>
...
gt::cols_label(member_casual = " ", rideable_type = "Bicycle Type")
```
...
::: {.btn .btn-outline-light .mb-4 type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvas68" aria-controls="offcanvas"}
Update Database =\> Preview Table
:::
:::
...
location_list <- dplyr::tbl(dbconn, "db/duration.db") |>
dplyr::group_by(mins) |>
dplyr::summarize(n = dplyr::n()) |>
colnames() |>
as.list()
...
gt::cols_label(mins = "Minutes", member_casual = " ")
...
gTable <- dplyr::tbl(dbconn, "db/duration.db") |>
dplyr::select(mins, member_casual) |>
dplyr::mutate(
...
::: {.btn .btn-outline-light .mb-4 type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvas78" aria-controls="offcanvas"}
Update Database =\> Preview Table
:::
:::
...
location_list <- dplyr::tbl(dbconn, "db/moy.db") |>
...
gt::cols_label(abbMonths = "Months of the Year", member_casual = " ")
...
::: {.btn .btn-outline-light .mb-4 type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvas98" aria-controls="offcanvas"}
Update Database =\> Preview Table
:::
:::
...
location_list <- dplyr::tbl(dbconn, "db/dow.db") |>
...
gt::cols_label(abbDays = "Days of the Week", member_casual = " ")
...
::: {.btn .btn-outline-light .mb-4 type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvas108" aria-controls="offcanvas"}
Update Database =\> Preview Table
:::
:::
...
location_list <- dplyr::tbl(dbconn, "db/hod_n.db") |>
dplyr::group_by(hr) |>
...
gt::cols_label(hr = "Hour of the Day", member_casual = " ")
...
::: {.btn .btn-outline-light .mb-4 type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvas118" aria-controls="offcanvas"}
Update Database =\> Preview Table
:::
:::
...
location_list <- dplyr::tbl(dbconn, "db/distance.db") |>
dplyr::select(milesR) |>
dplyr::group_by(milesR) |>
dplyr::summarize(n = dplyr::n()) |>
colnames() |>
as.list()
...
dplyr::tbl(dbconn, "db/distance.db") |>
dplyr::select(milesR, member_casual) |>
dplyr::group_by(milesR, member_casual) |>
dplyr::summarize(n = dplyr::n()) |>
dplyr::arrange(milesR, member_casual) |>
tabler(
...
gt::cols_label(milesR = "Miles", member_casual = " ")
...
gTable <- dplyr::tbl(dbconn, "db/distance.db") |>
dplyr::select(miles, member_casual) |>
dplyr::collect() |>
gtsummary::tbl_summary(
by = member_casual,
...
::: {.btn .btn-outline-light .mb-4 type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvas128" aria-controls="offcanvas"}
Update Database =\> Preview Table
:::
:::
...
location_list <- dplyr::tbl(dbconn, "db/speed.db") |>
dplyr::select(mphR) |>
dplyr::group_by(mphR) |>
dplyr::summarize(n = dplyr::n()) |>
colnames() |>
...
gt::tab_stubhead("Miles per Hour")
...
gtTable <- dplyr::tbl(dbconn, "db/speed.db") |>
dplyr::select(mph, member_casual) |>
dplyr::collect() |>
gtsummary::tbl_summary(
by = member_casual,
...
::: {.btn .btn-outline-light type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvas13" aria-controls="offcanvas"}
Code Steps
:::

::: {.btn .btn-outline-light type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvas14" aria-controls="offcanvas"}
Table Preview
:::
:::
:::
