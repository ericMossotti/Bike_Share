...
chi_table <- tabler(
title = gt::md("Chi-Square:<br>The statistical signficance of bicycle choice on member travel"),
source_note = gt::md("**Source**: `db/bType.db`"),
label = list(
...
regression_tbl |>
tabler(
title = gt::md("Binary Logistic Regression:<br>The likelihood of member bicycle choices"),
...
select_cols = c("trip_time", "member_casual")) |>
plotter(
title = "How are travel durations distributed across membership groups?",
...
#| fig-cap-location: bottom
#| tidy: true
#| fig-column: column-body-outset
#| fig-dpi: 300

gplot <- 
qdf_casual |>
plotter(
title = "Casual Travel Duration:\nWhat is the quartile distribution?",
x_label = "Minutes",
y_label = "n",
x_col = trip_time, 
geomType = "column", 
...
#| tbl-cap: "Modeling the probability of member travel by the duration."
#| tidy: true
...
exponentiate = TRUE) |>
tabler(
title = gt::md("Binary Logistic Regression:<br>The likelihood of member travel durations"),
...
gt::cols_label(abbMonths = "Months")
...
chi_table <- tabler(
title = "Chi-Square: The statistical signficance of the month on member travel",
source_note = gt::md("**Source**: `db/moy.db`"),
...
dplyr::collect() |>
plotter(
title = "How is monthly travel distributed across membership groups?",
x_label = paste0("Months"),
x_col = started_at, 
group_col = member_casual,
geomType = "other",
...
exponentiate = TRUE) |>
tabler(
title = gt::md("Binary Logistic Regression:<br>The likelihood of monthly member travel"),
source_note = gt::md("**Source**: `db/moy.db`"),
isBinary = TRUE)
...
-   To visualize the full daily dataset as a histogram with illustrated, colored-coded quartiles as dotted lines, see @fig-daysCasualHistogram and @fig-daysMemberHistogram (the solid yellow line represents the mean).
...
tabler(
title = "Chi-Square: The statistical signficance of the hour of day on member travel",
source_note = gt::md("**Source**: `db/moy.db`"),
...
dplyr::collect() |>
plotter(
title = "How is daily travel distributed across membership groups?",
x_label = paste0("Day"),
x_col = started_at, 
group_col = member_casual,
geomType = "other",
...
exponentiate = TRUE) |>
tabler(
title = gt::md("Binary Logistic Regression:<br>The likelihood of daily member travel"),
...
-   To visualize the full duration dataset as a histogram with illustrated, colored-coded quartiles as dotted lines, see @fig-hourCasualHistogram and @fig-hourMemberHistogram (the solid yellow line represents the mean).
...
dplyr::collect() |>
plotter(
title = "How is hourly distributed across membership groups?",
...
exponentiate = TRUE) |>
tabler(
title = gt::md("Binary Logistic Regression:<br>The likelihood of hourly member travel"),
...
dplyr::collect() |>
plotter(
title = "How is travel distance distributed across membership groups?",
x_label = "Miles",
x_col = miles, 
group_col = member_casual,
geomType = "column",
...
#| tbl-cap: "Modeling the probability of member travel by distance."
#| tidy: true
...
exponentiate = TRUE) |>
tabler(
title = gt::md("Binary Logistic Regression:<br>The likelihood of member travel distance"),
...
-   To visualize the full speed dataset as a histogram with illustrated, colored-coded quartiles as dotted lines, see @fig-speedCasualHistogram and @fig-speedMemberHistogram (the solid yellow line represents the mean).
...
dplyr::collect() |>
plotter(
title = "How is the esimated average travel speed distributed across membership groups?",
x_label = "Miles per Hour)",
x_col = mph, 
group_col = member_casual,
geomType = "column",
...
#| tbl-cap: "Modeling the probability of member travel by speed."
#| tidy: true
...
exponentiate = TRUE) |>
tabler(
title = gt::md("Binary Logistic Regression:<br>The likelihood of member travel speed"),
