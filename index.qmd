...
#| code-summary: The above would source and execute this script code if the conditions are met.
...
::::::::: {.btn .btn-secondary .align-self-center type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvas3" aria-controls="offcanvas"}
```{=html}
<i class="bi bi-code-slash" style="font-size: 32px; color: cornflowerblue"></i>
```
:::::::::
...
::::::::::
:::::::::::
:::::::::: {.flex-code style="margin-left: 15%; margin-top: 5%"}
```{r}
#| label: filterScript
...
:::::::: flex-code
```{r}
#| label: membershipFrequency_writeTbl
...
milesPlot <- milesTable |>
    ggplot2::ggplot(
        mapping = ggplot2::aes(x = Miles,
                               y = `Trips (in thousands)`)) +
    ggplot2::geom_count(colour = "seashell",
                        show.legend = FALSE) +
...
::: {#offcanvas15 .offcanvas .offcanvas-end tabindex="-1" aria-labelledby="offcanvas" style="width: 80vw"}
::: offcanvas-header
::: {.h5 .offcanvas-title}
Plots and Charts
:::
