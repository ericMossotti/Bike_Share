...
-   @tbl-memberTotals and @fig-overallFreq give an idea of the overall member to casual travel distribution.
:::
...
# So the first open plot publishes correctly, don't use this code chunk
gplot <- 
transformData(
conn = dbconn, 
path = "db/membership.db", 
