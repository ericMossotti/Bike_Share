...
ggplot2::ggplot(mapping = ggplot2::aes(x = Miles, y = `Trips (in thousands)`, color = `Trips (in thousands)`)) +
ggplot2::geom_line(show.legend = FALSE, size = 2) +
...
ggplot2::ggplot(mapping = ggplot2::aes(x = miles, y = n, color = member_casual)) +
