...
::: {.callout-note title="Filter the database"}
## Filter Database
...
::: {.p-1 .align-self-center}
Most of the mean mph observations fall in between 2-12 mph, as seen in @tbl-mphTotals and @fig-mphTotals. 
