---
title: "Case study of bike-sharing in the chicago area"
...
tidyr::tribble(
    ~" ", ~"Counts",
    "Original Total Obs.", original_nobs,
    "Total Obs. (incl. dupes, complete obs)", count_incorrectDists,
    "Dupes Removed", 
    (count_incorrectDists - count_correctDists),
    "Total Corrected Obs.", count_correctDists
    ) |>
    ...
    gt::tab_options(quarto.use_bootstrap = TRUE,
                    column_labels.font.weight = "heavier")
```
:::
