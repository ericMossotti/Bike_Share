...
### [Overall Exploration]{.panel-tabset-label}
::: plot-container
```{r}
...
y_col = n, 
geomType = "column", 
title = paste0("How often were the bicycle types chosen?"),
x_label = "Type", 
y_label = "n"
)
...
tabler( 
title = gt::md("How often were the bicycle<br>types chosen?"), 
...
tabler(
title = gt::md("Which bicycles do members tend to choose?"), 
...
-   To visualize the full duration dataset as a histogram with illustrated, colored-coded quartiles as dotted lines, see @fig-durationCasualHistogram and @fig-durationMemberHistogram (the solid yellow line represents the mean).

-   @tbl-modeldurationQ presents the results of a binary logistic regression analyzing the relationship between ride duration and membership status. The analysis divides ride duration into quartiles, with ***Q1 (1.02 - 5.73 minutes)*** serving as the reference category.
...
y_col = n,
geomType = "column", 
title = paste0("How long do people travel?"),
x_label = "Minutes", 
y_label = "n",
color_col = "black") +
...
tabler( 
title = gt::md("For how long<br>do people travel?"), 
...
tabler(
title = gt::md("How long do members ride for?"), 
groupName = "mins", 
label_n = "n",
note_list = list("membership status","occurrences"),
location_list = list("member_casual", "n"),
...
tabler(
title = gt::md("Which months do people<br>tend to travel?"),
...
plotter(
title = paste0("Which months do members ride?"),
x_label = "Months",
y_label = "n",
x_col = abbMonths, 
y_col = n, 
...
tabler(
title = gt::md("Which months do members prefer?"), 
groupName = "abbMonths", 
location = n,
label_n = "n",
note_list = list("membership status", "occurrences"),
...
tabler( 
title = gt::md("Which days do people<br>tend to travel?"),
...
tabler(
title = gt::md("Which days do members prefer?"), 
groupName = "abbDays", 
location = n,
label_n = "n",
note_list = list("membership status", "occurrences"),
...
tabler( 
title = gt::md("Which hours do people<br>tend to travel?"),
...
tabler(
title = gt::md("Which hours do members prefer?"), 
groupName = "hr", 
location = n,
label_n = "n",
note_list = list("membership status", "occurrences"),
...
tabler( 
title = gt::md("How far do people travel?"),
...
tabler(
title = gt::md("How far do members travel?"), 
groupName = "milesR", 
location = n,
label_n = "n",
note_list = list("membership status", "occurrences"),
...
tabler(
title = gt::md("How fast<br>do people travel?"),
...
tabler(
title = gt::md("How fast do members travel?"), 
groupName = "mphR", 
location = n,
label_n = "n",
note_list = list("membership status", "occurrences"),
