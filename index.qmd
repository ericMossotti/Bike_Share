...
hour_tbl |>
ggplot2::ggplot(ggplot2::aes(x = hour, y = n, fill = n)) +
ggplot2::geom_col(show.legend = TRUE) +
ggplot2::facet_grid(rows = "member_casual") +
ggplot2::scale_fill_distiller(
palette = "YlGnBu", 
...
title = "Speed", 
subtitle = "2023",
footnote = gt::md("Total trips taken <br> by mile per hour."),
location = n
)
