...
<a href="#offcanvas3" data-bs-toggle="offcanvas" aria-controls="offcanvas" shape-outside="
polygon(10.48px 1.65px, 9.52px 1.35px, 5.52px 14.35px, 6.48px 14.65px)">
<svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="cornflowerblue" class="bi bi-code-slash" viewBox="0 0 16 16">
