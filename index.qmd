...
::::: {.d-grid .gap-0}
::: {.callout-tip width="auto" title="Off-Canvas Buttons"}
...
:::{.p-1 style="font-size: 125%; text-align: center"}
$\text df = (rows - 1) \times (columns - 1)$
:::

#### The critical value {.unnumbered}
...
#### Calculation Process {.unnumbered}
...
#### Odds Ratio Calculation {.unnumbered}
...
#### Results Compiled As {.unnumbered}
